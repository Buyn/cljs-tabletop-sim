...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__13636){
var vec__13640 = p__13636;
...
var vec__13658 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13658,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13658,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13658,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_13991 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_13991(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_14030 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_14030(a,b);
}
});
...
var fexpr__13887 = (function (){var G__13888 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13888__$1)].join('')));

}
})();
return (fexpr__13887.cljs$core$IFn$_invoke$arity$2 ? fexpr__13887.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__13887.call(null,a,b));
}));
/**
