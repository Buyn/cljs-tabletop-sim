...
var G__17364 = o;
reagent.impl.template.goog$module$goog$object.set(G__17364,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__17785__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__17785 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__17793__i = 0, G__17793__a = new Array(arguments.length -  0);
while (G__17793__i < G__17793__a.length) {G__17793__a[G__17793__i] = arguments[G__17793__i + 0]; ++G__17793__i;}
  args = new cljs.core.IndexedSeq(G__17793__a,0,null);
} 
return G__17785__delegate.call(this,args);};
G__17785.cljs$lang$maxFixedArity = 0;
G__17785.cljs$lang$applyTo = (function (arglist__17794){
var args = cljs.core.seq(arglist__17794);
return G__17785__delegate(args);
});
...
var G__17403 = o;
reagent.impl.template.goog$module$goog$object.set(G__17403,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__17827__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__17828__i < G__17828__a.length) {G__17828__a[G__17828__i] = arguments[G__17828__i + 0]; ++G__17828__i;}
  args = new cljs.core.IndexedSeq(G__17828__a,0,null);
} 
return G__17827__delegate.call(this,args);};
G__17827.cljs$lang$maxFixedArity = 0;
G__17827.cljs$lang$applyTo = (function (arglist__17831){
var args = cljs.core.seq(arglist__17831);
return G__17827__delegate(args);
});
...
var G__17417 = props;
var G__17417__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17417,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17417);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17417__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__17422 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17422,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__17422;
}
})(),id_class);
...
var G__17423 = (cljs.core.count(argv) - first_child);
switch (G__17423) {
case (0):
...
var vec__17435 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17435,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17435,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17435,(2),null);
...
var temp__5808__auto___17863 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___17863 == null)){
} else {
var key_17864 = temp__5808__auto___17863;
(jsprops.key = key_17864);
}
...
var temp__5808__auto___17870 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___17870 == null)){
} else {
var key_17872 = temp__5808__auto___17870;
(jsprops.key = key_17872);
}
...
var temp__5808__auto___17885 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___17885 == null)){
} else {
var key_17887 = temp__5808__auto___17885;
(jsprops.key = key_17887);
}
...
var temp__5808__auto___17914 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___17914 == null)){
} else {
var key_17916 = temp__5808__auto___17914;
(jsprops.key = key_17916);
}
...
var temp__5808__auto___17922 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___17922 == null)){
} else {
var key_17929 = temp__5808__auto___17922;
(jsprops.key = key_17929);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17535_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__17535_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__17587 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17587,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17587,(1),null);
...
break;
default:
var G__17947 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__17948 = compiler;
v = G__17947;
compiler = G__17948;
continue;
...
var G__17644 = tag;
var G__17644__$1 = (((G__17644 instanceof cljs.core.Keyword))?G__17644.fqn:null);
switch (G__17644__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template17702 = (function (opts,id,fn_to_element,parse_fn,meta17703){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template17702.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17704,meta17703__$1){
var self__ = this;
var _17704__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template17702(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta17703__$1));
}));

(reagent.impl.template.t_reagent$impl$template17702.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17704){
var self__ = this;
var _17704__$1 = this;
return self__.meta17703;
}));

(reagent.impl.template.t_reagent$impl$template17702.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template17702.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template17702.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template17702.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template17702.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template17702.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta17703","meta17703",243860860,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template17702.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template17702.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template17702");

(reagent.impl.template.t_reagent$impl$template17702.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template17702");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template17702.
 */
reagent.impl.template.__GT_t_reagent$impl$template17702 = (function reagent$impl$template$__GT_t_reagent$impl$template17702(opts,id,fn_to_element,parse_fn,meta17703){
return (new reagent.impl.template.t_reagent$impl$template17702(opts,id,fn_to_element,parse_fn,meta17703));
});
...
return (new reagent.impl.template.t_reagent$impl$template17702(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
