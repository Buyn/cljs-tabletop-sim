...
var i_14980 = (0);
while(true){
if((i_14980 < arr.length)){
(arr[i_14980] = null);

var G__14981 = (i_14980 + (1));
i_14980 = G__14981;
continue;
} else {
}
...
var i_15001 = (self__.level + (1));
while(true){
if((i_15001 <= (new_level + (1)))){
(update[i_15001] = self__.header);

var G__15004 = (i_15001 + (1));
i_15001 = G__15004;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_15006 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_15006[i]));
} else {
x__$2.forward.push((((i < links_15006.length))?(links_15006[i]):null));
}

if((i < links_15006.length)){
(links_15006[i] = x__$2);
} else {
links_15006.push(x__$2);
}
...
var i_15014 = (0);
while(true){
if((i_15014 <= self__.level)){
var links_15017 = (update[i_15014]).forward;
if((x__$1 === (((i_15014 < links_15017.length))?(links_15017[i_15014]):null))){
(links_15017[i_15014] = (x__$1.forward[i_15014]));

var G__15020 = (i_15014 + (1));
i_15014 = G__15020;
continue;
} else {
var G__15021 = (i_15014 + (1));
i_15014 = G__15021;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__15047 = nx;
var G__15048 = (level__$1 - (1));
x = G__15047;
level__$1 = G__15048;
continue;
} else {
var G__15050 = x;
var G__15051 = (level__$1 - (1));
x = G__15050;
level__$1 = G__15051;
continue;
}
