...
var vec__31525 = tabletop.state.placement_pos();
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31525,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31525,(1),null);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(tabletop.state.app_state,(function (p1__31528_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__31528_SHARP_,deserialized], 0)),new cljs.core.Keyword(null,"view","view",1247994814),new cljs.core.Keyword(null,"table","table",-564943036),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"error","error",-978969032),null], 0));
}));
}catch (e31529){var ex = e31529;
...
tabletop.components.component_panel.component_panel = (function tabletop$components$component_panel$component_panel(p__31531){
var map__31532 = p__31531;
var map__31532__$1 = cljs.core.__destructure_map(map__31532);
var on_open_customizer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31532__$1,new cljs.core.Keyword(null,"on-open-customizer","on-open-customizer",1557307706));
var on_open_tile_panel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31532__$1,new cljs.core.Keyword(null,"on-open-tile-panel","on-open-tile-panel",-568960476));
...
var on_open_customizer__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31534__$1,new cljs.core.Keyword(null,"on-open-customizer","on-open-customizer",1557307706));
var on_open_tile_panel__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31534__$1,new cljs.core.Keyword(null,"on-open-tile-panel","on-open-tile-panel",-568960476));
var map__31535 = cljs.core.deref(tabletop.state.app_state);
var map__31535__$1 = cljs.core.__destructure_map(map__31535);
var menu_open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31535__$1,new cljs.core.Keyword(null,"menu-open","menu-open",1430293295));
var menu_section = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31535__$1,new cljs.core.Keyword(null,"menu-section","menu-section",1290407139));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31539),tabletop$components$component_panel$component_panel_$_iter__31536(cljs.core.chunk_rest(s__31537__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31539),null);
}
} else {
var faces = cljs.core.first(s__31537__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-full.text-left.px-3.py-2.rounded.bg-gray-700.hover:bg-gray-600.mb-1.text-sm","button.w-full.text-left.px-3.py-2.rounded.bg-gray-700.hover:bg-gray-600.mb-1.text-sm",-1720407992),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),faces,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (faces,s__31537__$2,temp__5804__auto__,map__31535,map__31535__$1,menu_open,menu_section,map__31534,map__31534__$1,on_open_customizer__$1,on_open_tile_panel__$1,file_input,map__31532,map__31532__$1,on_open_customizer,on_open_tile_panel){
return (function (){
var vec__31543 = tabletop.state.placement_pos();
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31543,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31543,(1),null);
return tabletop.state.add_component_BANG_(tabletop.logic.dice.make_die.cljs$core$IFn$_invoke$arity$3(faces,x,y));
});})(faces,s__31537__$2,temp__5804__auto__,map__31535,map__31535__$1,menu_open,menu_section,map__31534,map__31534__$1,on_open_customizer__$1,on_open_tile_panel__$1,file_input,map__31532,map__31532__$1,on_open_customizer,on_open_tile_panel))
], null),["d",cljs.core.str.cljs$core$IFn$_invoke$arity$1(faces)].join('')], null),tabletop$components$component_panel$component_panel_$_iter__31536(cljs.core.rest(s__31537__$2)));
}
} else {
return null;
}
...
})], null),"Load Game"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"file",new cljs.core.Keyword(null,"accept","accept",1874130431),".json",new cljs.core.Keyword(null,"class","class",-2030961996),"hidden",new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__31530_SHARP_){
return cljs.core.reset_BANG_(file_input,p1__31530_SHARP_);
