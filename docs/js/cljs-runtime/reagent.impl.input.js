...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__17170){
var map__17171 = p__17170;
var map__17171__$1 = cljs.core.__destructure_map(map__17171);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17171__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__17178 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__17179 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__17179);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__17178);
}}));
} else {
...
(jsprops.onChange = (function (p1__17208_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__17208_SHARP_);
}));
