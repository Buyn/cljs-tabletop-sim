...
var vec__26920 = cljs.core.deref(tabletop.components.table.last_mouse_pos);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26920,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26920,(1),null);
...
var map__26931 = new cljs.core.Keyword(null,"table","table",-564943036).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tabletop.state.app_state));
var map__26931__$1 = cljs.core.__destructure_map(map__26931);
var pan_x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26931__$1,new cljs.core.Keyword(null,"pan-x","pan-x",-1761589747));
var pan_y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26931__$1,new cljs.core.Keyword(null,"pan-y","pan-y",915543213));
var zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26931__$1,new cljs.core.Keyword(null,"zoom","zoom",-1827487038));
...
return (function (){
var map__26952 = new cljs.core.Keyword(null,"table","table",-564943036).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tabletop.state.app_state));
var map__26952__$1 = cljs.core.__destructure_map(map__26952);
var pan_x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26952__$1,new cljs.core.Keyword(null,"pan-x","pan-x",-1761589747));
var pan_y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26952__$1,new cljs.core.Keyword(null,"pan-y","pan-y",915543213));
var zoom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26952__$1,new cljs.core.Keyword(null,"zoom","zoom",-1827487038));
...
var vec__26953 = (function (){var or__5002__auto__ = cljs.core.deref(sel_start);
...
var sx1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26953,(0),null);
var sy1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26953,(1),null);
var vec__26956 = (function (){var or__5002__auto__ = cljs.core.deref(sel_end);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null);
...
var sx2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26956,(0),null);
var sy2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26956,(1),null);
...
var vec__26959 = tabletop.components.table.client__GT_table(e.clientX,e.clientY,pan_x,pan_y,zoom);
var tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26959,(0),null);
var ty = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26959,(1),null);
...
var vec__26962_26981 = tabletop.components.table.client__GT_table(e.clientX,e.clientY,pan_x,pan_y,zoom);
var tx_26982 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26962_26981,(0),null);
var ty_26983 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26962_26981,(1),null);
tabletop.state.set_last_middle_click_BANG_(tx_26982,ty_26983);
...
var vec__26965 = tabletop.components.table.client__GT_table(e.clientX,e.clientY,pan_x,pan_y,zoom);
var tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26965,(0),null);
var ty = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26965,(1),null);
return cljs.core.reset_BANG_(sel_end,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tx,ty], null));
} else {
...
var selected_ids_26985 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__26951_SHARP_){
return tabletop.components.table.rect_intersects_QMARK_(rect_x1,rect_y1,rect_x2,rect_y2,p1__26951_SHARP_);
}),components));
tabletop.state.set_selection_BANG_(selected_ids_26985);
...
var cx = e.clientX;
var cy = e.clientY;
var vec__26971 = tabletop.components.table.client__GT_table(cx,cy,pan_x,pan_y,zoom);
var tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26971,(0),null);
var ty = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26971,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26977),tabletop$components$table$table_$_iter__26974(cljs.core.chunk_rest(s__26975__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26977),null);
}
} else {
var component = cljs.core.first(s__26975__$2);
return cljs.core.cons((function (){var G__26979 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(component);
...
})(),tabletop$components$table$table_$_iter__26974(cljs.core.rest(s__26975__$2)));
}
} else {
return null;
}
