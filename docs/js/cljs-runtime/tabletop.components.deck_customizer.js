...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-wrap.gap-1","div.flex.flex-wrap.gap-1",1063862912),(function (){var iter__5480__auto__ = (function tabletop$components$deck_customizer$color_picker_$_iter__26791(s__26792){
return (new cljs.core.LazySeq(null,(function (){
var s__26792__$1 = s__26792;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26792__$1);
if(temp__5804__auto__){
var s__26792__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26792__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26792__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26794 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26793 = (0);
while(true){
if((i__26793 < size__5479__auto__)){
var c = cljs.core._nth(c__5478__auto__,i__26793);
cljs.core.chunk_append(b__26794,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-6.h-6.rounded-full.border-2.transition-all","button.w-6.h-6.rounded-full.border-2.transition-all",1073965035),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,selected))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26793,c,c__5478__auto__,size__5479__auto__,b__26794,s__26792__$2,temp__5804__auto__){
return (function (){
return (on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(c) : on_pick.call(null,c));
});})(i__26793,c,c__5478__auto__,size__5479__auto__,b__26794,s__26792__$2,temp__5804__auto__))
], null)], null));

var G__26919 = (i__26793 + (1));
i__26793 = G__26919;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26794),tabletop$components$deck_customizer$color_picker_$_iter__26791(cljs.core.chunk_rest(s__26792__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26794),null);
}
} else {
var c = cljs.core.first(s__26792__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-6.h-6.rounded-full.border-2.transition-all","button.w-6.h-6.rounded-full.border-2.transition-all",1073965035),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,selected))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (c,s__26792__$2,temp__5804__auto__){
return (function (){
return (on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(c) : on_pick.call(null,c));
});})(c,s__26792__$2,temp__5804__auto__))
], null)], null),tabletop$components$deck_customizer$color_picker_$_iter__26791(cljs.core.rest(s__26792__$2)));
}
} else {
return null;
}
...
tabletop.components.deck_customizer.deck_customizer = (function tabletop$components$deck_customizer$deck_customizer(p__26840){
var map__26841 = p__26840;
var map__26841__$1 = cljs.core.__destructure_map(map__26841);
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26841__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
...
var map__26847__$1 = cljs.core.__destructure_map(map__26847);
var on_close__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26847__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var map__26854 = cljs.core.deref(form);
var map__26854__$1 = cljs.core.__destructure_map(map__26854);
var suits = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26854__$1,new cljs.core.Keyword(null,"suits","suits",-426777515));
var ranks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26854__$1,new cljs.core.Keyword(null,"ranks","ranks",-1802584866));
var total_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26854__$1,new cljs.core.Keyword(null,"total-count","total-count",-1999441386));
var face_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26854__$1,new cljs.core.Keyword(null,"face-color","face-color",-919913463));
var back_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26854__$1,new cljs.core.Keyword(null,"back-color","back-color",-672417547));
var text_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26854__$1,new cljs.core.Keyword(null,"text-color","text-color",1728708298));
var map__26855 = (function (){var or__5002__auto__ = cljs.core.deref(errors);
...
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26881__$1,new cljs.core.Keyword(null,"color","color",1011675173));
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.items-center.gap-2.mb-2","div.flex.items-center.gap-2.mb-2",1764808081),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.text-sm.w-16.text-gray-600","label.text-sm.w-16.text-gray-600",-700380134),["Suit ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((i + (1)))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.rounded.px-2.py-1.text-sm.w-24.text-gray-600","input.border.rounded.px-2.py-1.text-sm.w-24.text-gray-600",-1963822725),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20),new cljs.core.Keyword(null,"value","value",305978217),label,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26828_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"suits","suits",-426777515),i,new cljs.core.Keyword(null,"label","label",1718410804)], null),p1__26828_SHARP_.target.value);
})], null)], null),(function (){var iter__5480__auto__ = (function tabletop$components$deck_customizer$deck_customizer_$_iter__26885(s__26886){
return (new cljs.core.LazySeq(null,(function (){
...
var c__5478__auto__ = cljs.core.chunk_first(s__26886__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26888 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26887 = (0);
while(true){
if((i__26887 < size__5479__auto__)){
var c = cljs.core._nth(c__5478__auto__,i__26887);
cljs.core.chunk_append(b__26888,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-5.h-5.rounded-full.border-2.transition-all","button.w-5.h-5.rounded-full.border-2.transition-all",1139203765),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,color))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26887,c,c__5478__auto__,size__5479__auto__,b__26888,s__26886__$2,temp__5804__auto__,map__26881,map__26881__$1,label,color,map__26854,map__26854__$1,suits,ranks,total_count,face_color,back_color,text_color,map__26855,map__26855__$1,suit_errors,rank_errors,map__26847,map__26847__$1,on_close__$1,form,errors,map__26841,map__26841__$1,on_close){
return (function (){
...
});})(i__26887,c,c__5478__auto__,size__5479__auto__,b__26888,s__26886__$2,temp__5804__auto__,map__26881,map__26881__$1,label,color,map__26854,map__26854__$1,suits,ranks,total_count,face_color,back_color,text_color,map__26855,map__26855__$1,suit_errors,rank_errors,map__26847,map__26847__$1,on_close__$1,form,errors,map__26841,map__26841__$1,on_close))
], null)], null));

var G__26950 = (i__26887 + (1));
i__26887 = G__26950;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26888),tabletop$components$deck_customizer$deck_customizer_$_iter__26885(cljs.core.chunk_rest(s__26886__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26888),null);
}
} else {
var c = cljs.core.first(s__26886__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-5.h-5.rounded-full.border-2.transition-all","button.w-5.h-5.rounded-full.border-2.transition-all",1139203765),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,color))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (c,s__26886__$2,temp__5804__auto__,map__26881,map__26881__$1,label,color,map__26854,map__26854__$1,suits,ranks,total_count,face_color,back_color,text_color,map__26855,map__26855__$1,suit_errors,rank_errors,map__26847,map__26847__$1,on_close__$1,form,errors,map__26841,map__26841__$1,on_close){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"suits","suits",-426777515),i,new cljs.core.Keyword(null,"color","color",1011675173)], null),c);
});})(c,s__26886__$2,temp__5804__auto__,map__26881,map__26881__$1,label,color,map__26854,map__26854__$1,suits,ranks,total_count,face_color,back_color,text_color,map__26855,map__26855__$1,suit_errors,rank_errors,map__26847,map__26847__$1,on_close__$1,form,errors,map__26841,map__26841__$1,on_close))
], null)], null),tabletop$components$deck_customizer$deck_customizer_$_iter__26885(cljs.core.rest(s__26886__$2)));
}
} else {
return null;
}
...
var y__5091__auto__ = parseInt(p1__26829_SHARP_.target.value,(10));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.items-center.gap-2.mb-2","div.flex.items-center.gap-2.mb-2",1764808081),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.text-sm.w-16.text-gray-600","label.text-sm.w-16.text-gray-600",-700380134),["Rank ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((i + (1)))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.rounded.px-2.py-1.text-sm.flex-1.text-gray-600","input.border.rounded.px-2.py-1.text-sm.flex-1.text-gray-600",2084349755),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"max-length","max-length",-254826109),(10),new cljs.core.Keyword(null,"value","value",305978217),rank,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__26830_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ranks","ranks",-1802584866),i], null),p1__26830_SHARP_.target.value);
...
var cfg_SINGLEQUOTE_ = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cfg,new cljs.core.Keyword(null,"ranks","ranks",-1802584866),(function (p1__26838_SHARP_){
return tabletop.logic.shuffle.auto_fill_ranks(p1__26838_SHARP_,new cljs.core.Keyword(null,"total-count","total-count",-1999441386).cljs$core$IFn$_invoke$arity$1(cfg));
}));
...
var vec__26899_26968 = tabletop.state.placement_pos();
var px_26969 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26899_26968,(0),null);
var py_26970 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26899_26968,(1),null);
tabletop.state.add_component_BANG_(new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"deck","deck",1145325705),new cljs.core.Keyword(null,"x","x",2099068185),px_26969,new cljs.core.Keyword(null,"y","y",-1757859776),py_26970,new cljs.core.Keyword(null,"cards","cards",169174038),tabletop.logic.shuffle.make_custom_deck(cfg_SINGLEQUOTE_),new cljs.core.Keyword(null,"custom?","custom?",-124620022),true], null));
