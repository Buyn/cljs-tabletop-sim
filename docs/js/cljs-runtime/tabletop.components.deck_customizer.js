...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-wrap.gap-1","div.flex.flex-wrap.gap-1",1063862912),(function (){var iter__5480__auto__ = (function tabletop$components$deck_customizer$color_picker_$_iter__31047(s__31048){
return (new cljs.core.LazySeq(null,(function (){
var s__31048__$1 = s__31048;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__31048__$1);
if(temp__5804__auto__){
var s__31048__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31048__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__31048__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__31050 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__31049 = (0);
while(true){
if((i__31049 < size__5479__auto__)){
var c = cljs.core._nth(c__5478__auto__,i__31049);
cljs.core.chunk_append(b__31050,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-6.h-6.rounded-full.border-2.transition-all","button.w-6.h-6.rounded-full.border-2.transition-all",1073965035),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,selected))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__31049,c,c__5478__auto__,size__5479__auto__,b__31050,s__31048__$2,temp__5804__auto__){
return (function (){
return (on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(c) : on_pick.call(null,c));
});})(i__31049,c,c__5478__auto__,size__5479__auto__,b__31050,s__31048__$2,temp__5804__auto__))
], null)], null));

var G__31222 = (i__31049 + (1));
i__31049 = G__31222;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31050),tabletop$components$deck_customizer$color_picker_$_iter__31047(cljs.core.chunk_rest(s__31048__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31050),null);
}
} else {
var c = cljs.core.first(s__31048__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-6.h-6.rounded-full.border-2.transition-all","button.w-6.h-6.rounded-full.border-2.transition-all",1073965035),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,selected))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (c,s__31048__$2,temp__5804__auto__){
return (function (){
return (on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(c) : on_pick.call(null,c));
});})(c,s__31048__$2,temp__5804__auto__))
], null)], null),tabletop$components$deck_customizer$color_picker_$_iter__31047(cljs.core.rest(s__31048__$2)));
}
} else {
return null;
}
...
tabletop.components.deck_customizer.deck_customizer = (function tabletop$components$deck_customizer$deck_customizer(p__31117){
var map__31118 = p__31117;
var map__31118__$1 = cljs.core.__destructure_map(map__31118);
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31118__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
...
return (function (p__31135){
var map__31136 = p__31135;
var map__31136__$1 = cljs.core.__destructure_map(map__31136);
var on_close__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31136__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var map__31137 = cljs.core.deref(form);
var map__31137__$1 = cljs.core.__destructure_map(map__31137);
var suits = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31137__$1,new cljs.core.Keyword(null,"suits","suits",-426777515));
var ranks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31137__$1,new cljs.core.Keyword(null,"ranks","ranks",-1802584866));
var total_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31137__$1,new cljs.core.Keyword(null,"total-count","total-count",-1999441386));
var face_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31137__$1,new cljs.core.Keyword(null,"face-color","face-color",-919913463));
var back_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31137__$1,new cljs.core.Keyword(null,"back-color","back-color",-672417547));
var text_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31137__$1,new cljs.core.Keyword(null,"text-color","text-color",1728708298));
var map__31138 = (function (){var or__5002__auto__ = cljs.core.deref(errors);
...
var suit_errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31138__$1,new cljs.core.Keyword(null,"suit-errors","suit-errors",-1927910250));
var rank_errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31138__$1,new cljs.core.Keyword(null,"rank-errors","rank-errors",1753146222));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.fixed.inset-0.flex.items-center.justify-center.z-50","div.fixed.inset-0.flex.items-center.justify-center.z-50",-1902175422),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background","background",-863952629),"rgba(0,0,0,0.5)"], null)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.rounded-lg.shadow-xl.w-full.max-w-lg.flex.flex-col","div.bg-white.rounded-lg.shadow-xl.w-full.max-w-lg.flex.flex-col",-367105014),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-height","max-height",-612563804),"90vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.px-6.py-4.border-b","div.px-6.py-4.border-b",-1209882696),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.text-lg.font-semibold","h2.text-lg.font-semibold",-2017038774),"Customize Deck"], null)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.overflow-y-auto.px-6.py-4.flex-1","div.overflow-y-auto.px-6.py-4.flex-1",-638228094),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"section.mb-6","section.mb-6",88777537),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.text-sm.font-bold.uppercase.tracking-wider.text-gray-500.mb-2","h3.text-sm.font-bold.uppercase.tracking-wider.text-gray-500.mb-2",-1179057006),"Suits (4)"], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__31145){
var map__31146 = p__31145;
var map__31146__$1 = cljs.core.__destructure_map(map__31146);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31146__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31146__$1,new cljs.core.Keyword(null,"color","color",1011675173));
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.items-center.gap-2.mb-2","div.flex.items-center.gap-2.mb-2",1764808081),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.text-sm.w-16.text-gray-600","label.text-sm.w-16.text-gray-600",-700380134),["Suit ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((i + (1)))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.rounded.px-2.py-1.text-sm.w-24.text-gray-600","input.border.rounded.px-2.py-1.text-sm.w-24.text-gray-600",-1963822725),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20),new cljs.core.Keyword(null,"value","value",305978217),label,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__31093_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"suits","suits",-426777515),i,new cljs.core.Keyword(null,"label","label",1718410804)], null),p1__31093_SHARP_.target.value);
})], null)], null),(function (){var iter__5480__auto__ = (function tabletop$components$deck_customizer$deck_customizer_$_iter__31147(s__31148){
return (new cljs.core.LazySeq(null,(function (){
var s__31148__$1 = s__31148;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__31148__$1);
if(temp__5804__auto__){
var s__31148__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31148__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__31148__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__31150 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__31149 = (0);
while(true){
if((i__31149 < size__5479__auto__)){
var c = cljs.core._nth(c__5478__auto__,i__31149);
cljs.core.chunk_append(b__31150,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-5.h-5.rounded-full.border-2.transition-all","button.w-5.h-5.rounded-full.border-2.transition-all",1139203765),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,color))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__31149,c,c__5478__auto__,size__5479__auto__,b__31150,s__31148__$2,temp__5804__auto__,map__31146,map__31146__$1,label,color,map__31137,map__31137__$1,suits,ranks,total_count,face_color,back_color,text_color,map__31138,map__31138__$1,suit_errors,rank_errors,map__31136,map__31136__$1,on_close__$1,form,errors,map__31118,map__31118__$1,on_close){
return (function (){
...
});})(i__31149,c,c__5478__auto__,size__5479__auto__,b__31150,s__31148__$2,temp__5804__auto__,map__31146,map__31146__$1,label,color,map__31137,map__31137__$1,suits,ranks,total_count,face_color,back_color,text_color,map__31138,map__31138__$1,suit_errors,rank_errors,map__31136,map__31136__$1,on_close__$1,form,errors,map__31118,map__31118__$1,on_close))
], null)], null));

var G__31245 = (i__31149 + (1));
i__31149 = G__31245;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31150),tabletop$components$deck_customizer$deck_customizer_$_iter__31147(cljs.core.chunk_rest(s__31148__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31150),null);
}
} else {
var c = cljs.core.first(s__31148__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.w-5.h-5.rounded-full.border-2.transition-all","button.w-5.h-5.rounded-full.border-2.transition-all",1139203765),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),c,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"background-color","background-color",570434026),c,new cljs.core.Keyword(null,"border-color","border-color",-2059162761),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c,color))?"#3b82f6":"#d1d5db")], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (c,s__31148__$2,temp__5804__auto__,map__31146,map__31146__$1,label,color,map__31137,map__31137__$1,suits,ranks,total_count,face_color,back_color,text_color,map__31138,map__31138__$1,suit_errors,rank_errors,map__31136,map__31136__$1,on_close__$1,form,errors,map__31118,map__31118__$1,on_close){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"suits","suits",-426777515),i,new cljs.core.Keyword(null,"color","color",1011675173)], null),c);
});})(c,s__31148__$2,temp__5804__auto__,map__31146,map__31146__$1,label,color,map__31137,map__31137__$1,suits,ranks,total_count,face_color,back_color,text_color,map__31138,map__31138__$1,suit_errors,rank_errors,map__31136,map__31136__$1,on_close__$1,form,errors,map__31118,map__31118__$1,on_close))
], null)], null),tabletop$components$deck_customizer$deck_customizer_$_iter__31147(cljs.core.rest(s__31148__$2)));
}
} else {
return null;
}
...
var y__5091__auto__ = parseInt(p1__31098_SHARP_.target.value,(10));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.items-center.gap-2.mb-2","div.flex.items-center.gap-2.mb-2",1764808081),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.text-sm.w-16.text-gray-600","label.text-sm.w-16.text-gray-600",-700380134),["Rank ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((i + (1)))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.rounded.px-2.py-1.text-sm.flex-1.text-gray-600","input.border.rounded.px-2.py-1.text-sm.flex-1.text-gray-600",2084349755),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"max-length","max-length",-254826109),(10),new cljs.core.Keyword(null,"value","value",305978217),rank,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__31101_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(form,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ranks","ranks",-1802584866),i], null),p1__31101_SHARP_.target.value);
...
var cfg_SINGLEQUOTE_ = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cfg,new cljs.core.Keyword(null,"ranks","ranks",-1802584866),(function (p1__31109_SHARP_){
return tabletop.logic.shuffle.auto_fill_ranks(p1__31109_SHARP_,new cljs.core.Keyword(null,"total-count","total-count",-1999441386).cljs$core$IFn$_invoke$arity$1(cfg));
}));
...
var vec__31206_31281 = tabletop.state.placement_pos();
var px_31282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31206_31281,(0),null);
var py_31283 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31206_31281,(1),null);
tabletop.state.add_component_BANG_(new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"deck","deck",1145325705),new cljs.core.Keyword(null,"x","x",2099068185),px_31282,new cljs.core.Keyword(null,"y","y",-1757859776),py_31283,new cljs.core.Keyword(null,"cards","cards",169174038),tabletop.logic.shuffle.make_custom_deck(cfg_SINGLEQUOTE_),new cljs.core.Keyword(null,"custom?","custom?",-124620022),true], null));
